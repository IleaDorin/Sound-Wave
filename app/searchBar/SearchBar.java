    ...
    public List<LibraryEntry> search(final Filters filters, final String type) {
        ...
        switch (type) {
            ...
            case "artist":
                ...
                ArrayList<Artist> artists = Admin.getAllArtists();
                for (Artist artist : artists) {
                    if (artist.getUsername().toLowerCase().startsWith(filters.getName()
                            .toLowerCase())) {
                       ArtistEntry artistEntry = new ArtistEntry(artist.getUsername());
            ...
            case "host":
                ...
                for (Host host : hosts) {
                    if (host.getUsername().toLowerCase().startsWith(filters.getName()
                            .toLowerCase())) {
                        ArtistEntry artistEntry = new ArtistEntry(host.getUsername());
                        entries.add(artistEntry);
                    }
                }
                break;
